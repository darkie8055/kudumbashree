        ...
        >
          {isEditing ? (
            ...
            <Text style={styles.detailText}>
              Aadhaar No: {userDetails.aadhaarNo}
            </Text>
          )}
          {isEditing ? (
            <TextInput
          ...
          {isEditing ? (
            ...
            <Text style={styles.detailText}>
              Bank Copy: {userDetails.bankCopy}
            </Text>
          )}
          {isEditing ? (
            <TextInput
...
const styles = StyleSheet.create({
  ...
  detailsBox: {
    padding: 15,
    borderWidth: 1,
    borderColor: "#000", // Only one border here
    paddingBottom: 5,
  },
  editableBox: {
    backgroundColor: "#f0f0f0", // Lighter background for editable fields
  },
  infoRow: {
    marginBottom: 20,
  },
